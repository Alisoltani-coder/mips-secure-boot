...
- **GitHub Repository:** [mips-secure-boot](https://github.com/Alisoltani-coder/mips-secure-boot)
- **Sharif LaTeX Report:** [View the project report](https://latex.sharif.edu/read/txgmhjwtvjqy)
...
4. **Simulation Scenarios:** Start a simulation (`Simulate > Start Simulation`) and choose one of the following testbenches from the `work` library:
   ...
   * **`tb_tampered_program`:** Simulates a modified or corrupted user program. The hash verification will fail, and the system will safely halt in Secure Mode (`Mode_Bit = 1`).
